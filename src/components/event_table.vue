<template>
  <div class="event-all" :class="{'event-all-show': isShow}">
    <div class="table-box">
       <div class="edit-input" :class="{'edit-input-show': is_edit}">
          <input type="text" name="" value="" ref="content" v-model="info.content">
          <button type="button" name="button" @click="editData">确定</button>
       </div>
       ...
       <table class="event-table">
           ...
           <tbody>
               <tr v-for="(item,index) in notapad">
                   ...
                   <button class="del-btn" @click="showDialog(index,item.id)">删除</button></td>
               </tr>
           </tbody>
       </table>
    </div>
